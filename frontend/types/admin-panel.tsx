...
const mockBakeries: AdminBakery[] = [
  {
    ...
    description:
      'Panadería artesanal especializada en ochíos tradicionales de Úbeda',
    ...
    rating: 4.8,
    imageUrl:
      '/placeholder.svg?height=100&width=100&query=panaderia+san+isidro',
  },
  {
    id: 'b2',
    name: 'Panadería La Ubetense',
    description:
      'Ochíos y productos de panadería con más de 50 años de tradición',
...
const mockOrders: AdminOrder[] = [
  {
    ...
    items: [
      ...
      },
      {
        id: 'i2',
        productId: 'p2',
        productName: 'Ochío de Chocolate',
        quantity: 4,
        unitPrice: 1.5,
        total: 6.0,
      },
  ...
  const handleBakeryStatusChange = (bakeryId: string, status: BakeryStatus) => {
    setBakeries((prevBakeries) =>
      prevBakeries.map((bakery) =>
        bakery.id === bakeryId ? { ...bakery, status } : bakery
      )
    );
    toast({
