  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8 text-center">
        <h1 className="text-3xl font-bold mb-2">Historial de Pedidos - Ochío Club</h1>
        <p className="text-muted-foreground">Consulta y gestiona todos tus pedidos anteriores</p>
      </div>
