...
const initialOrders = [
  ...
  },
  {
    ...
    products: [{ id: "p3", name: "Ochío de Almendra", quantity: 12, price: 1.4 }],
    total: 16.8,
    status: "preparing",
  ...
  },
  {
    ...
    products: [{ id: "p2", name: "Ochío de Chocolate", quantity: 10, price: 1.5 }],
    total: 15.0,
    status: "on_the_way",
...
const initialProducts = [
  {
    ...
    isOutOfStock: false,
    isFeatured: true,
    ingredients: ["Harina", "Agua", "Aceite de oliva virgen extra", "Sal", "Levadura"],
    nutritionalInfo: {
      calories: 120,
      protein: 3,
      carbs: 18,
  ...
  },
  {
    ...
    isOutOfStock: false,
    isFeatured: true,
    ingredients: ["Harina", "Agua", "Aceite de oliva virgen extra", "Sal", "Levadura", "Chocolate"],
    nutritionalInfo: {
      calories: 150,
      protein: 3,
      carbs: 22,
  ...
  },
  {
    ...
    isOutOfStock: false,
    isFeatured: false,
    ingredients: ["Harina", "Agua", "Aceite de oliva virgen extra", "Sal", "Levadura", "Almendras"],
    nutritionalInfo: {
      calories: 140,
      protein: 4,
      carbs: 18,
  ...
  },
  {
    ...
    description: "Ochío con un toque de canela, ideal para los amantes de los sabores especiados.",
    price: 1.4,
    ...
    isOutOfStock: false,
    isFeatured: false,
    ingredients: ["Harina", "Agua", "Aceite de oliva virgen extra", "Sal", "Levadura", "Canela"],
    nutritionalInfo: {
      calories: 130,
      protein: 3,
      carbs: 19,
  ...
  },
  {
    ...
    description: "Ochío relleno de crema pastelera, una delicia para los más golosos.",
    price: 1.6,
    ...
    isOutOfStock: false,
    isFeatured: true,
    ingredients: ["Harina", "Agua", "Aceite de oliva virgen extra", "Sal", "Levadura", "Crema pastelera"],
    nutritionalInfo: {
      calories: 180,
      protein: 3,
      carbs: 25,
  ...
  },
  {
    ...
    isOutOfStock: false,
    isFeatured: false,
    ingredients: ["Harina integral", "Agua", "Aceite de oliva virgen extra", "Sal", "Levadura", "Semillas"],
    nutritionalInfo: {
      calories: 110,
      protein: 4,
      carbs: 16,
  ...
  },
  {
    ...
    isOutOfStock: false,
    isFeatured: false,
    ingredients: ["Harina", "Agua", "Aceite de oliva virgen extra", "Sal", "Levadura", "Aceitunas negras"],
    nutritionalInfo: {
      calories: 135,
      protein: 3,
      carbs: 18,
