...
const statusConfig = {
  ...
  picked_up: { label: "Recogido", variant: "default" as const, className: "bg-indigo-100 text-indigo-800" },
  on_the_way: { label: "En camino", variant: "default" as const, className: "bg-blue-100 text-blue-800" },
  ...
  return (
    <Card className={className}>
      <CardHeader>
        ...
        <CardDescription>Lista de los últimos pedidos recibidos</CardDescription>
      </CardHeader>
      <CardContent>
                  ...
                  <TableRow key={order.id}>
                    ...
                    <TableCell>
                      <div className="text-xs">
                        <div>{format(order.date, "dd/MM/yyyy", { locale: es })}</div>
                        <div className="text-muted-foreground">{format(order.date, "HH:mm", { locale: es })}</div>
                      </div>
                    </TableCell>
