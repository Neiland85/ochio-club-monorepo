    ...
    const interval = setInterval(() => {
      setMetrics((prev) => ({
        ...
        dbConnections: Math.max(
          ...
          Math.min(
            200,
            prev.dbConnections + Math.floor((Math.random() - 0.5) * 20)
          )
        ),
        apiLatency: Math.max(
          100,
          Math.min(500, prev.apiLatency + (Math.random() - 0.5) * 50)
        ),
    ...
    <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <span
                className={`text-sm ${getStatusColor(metrics.cpu, [70, 85])}`}
              >
                {metrics.cpu < 70
                  ? 'Óptimo'
                  : metrics.cpu < 85
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <span
                className={`text-sm ${getStatusColor(metrics.ram, [75, 90])}`}
              >
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <span
                className={`text-sm ${getStatusColor(metrics.disk, [60, 80])}`}
              >
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <span
                className={`text-sm ${getStatusColor(metrics.network, [70, 90])}`}
              >
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <span
                className={`text-sm ${getStatusColor(metrics.apiLatency, [300, 500])}`}
              >
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <span className="text-sm text-blue-600">
                +{Math.floor(Math.random() * 50)} nuevos
              </span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <span
                className={`text-sm ${getStatusColor(metrics.errorRate, [1, 5])}`}
              >
                {metrics.errorRate < 1
                  ? 'Excelente'
                  : metrics.errorRate < 5
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Estado actual de las alertas y notificaciones
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div className="flex items-center gap-3 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700">
                    El uso de CPU está en {metrics.cpu.toFixed(1)}%
                  </p>
                </div>
              </div>
            )}
            ...
            {metrics.ram > 75 && (
              <div className="flex items-center gap-3 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700">
                    El uso de RAM está en {metrics.ram.toFixed(1)}%
                  </p>
                </div>
              </div>
            )}
            ...
            {metrics.apiLatency > 300 && (
              <div className="flex items-center gap-3 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700">
                    Latencia de {metrics.apiLatency.toFixed(0)}ms detectada
                  </p>
                </div>
              </div>
            )}
