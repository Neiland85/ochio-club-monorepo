  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">Gestiona usuarios, panaderías, productos y pedidos desde un solo lugar</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-lg border p-4">
          ...
          <p className="text-xs text-muted-foreground">Panaderías registradas</p>
        </div>
        <div className="rounded-lg border p-4">
