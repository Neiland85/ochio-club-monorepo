...
export default function UserProfile({
  ...
  const validateProfile = (): boolean => {
    ...
    if (
      ...
      !/^\d{5}$/.test(userData.address.postalCode)
    ) {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder="23400"
                        className={
                          profileErrors.postalCode ? 'border-red-500' : ''
                        }
                      />
        ...
        <TabsContent value="preferences">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Personaliza tu experiencia en Ochío Club
              </CardDescription>
            </CardHeader>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      checked={
                        userData.preferences?.notifications?.push ?? true
                      }
                    />
                  </div>
                </div>
