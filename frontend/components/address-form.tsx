...
import type { AddressFormProps, AddressFormData, AddressFormErrors } from "@/types/address-selector"
...
export default function AddressForm({ address, onSubmit, onCancel, isLoading = false }: AddressFormProps) {
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        <CardTitle>{address ? "Editar Dirección" : "Añadir Nueva Dirección"}</CardTitle>
        <CardDescription>
          {address
